...
a = """
want start saying amazingly easy super quick meal ton potential followed recipe fairly close decided add garlic italian seasoning help flavor n't work bland recipe needs flavor spices cumin doubled n't noticeable even mixed early seasonings could marinate cheese good spices n't know enough mix n't put much one knows could make amazing
""".strip()
print(a)
x = te.get_emotion(a)
print(x)
